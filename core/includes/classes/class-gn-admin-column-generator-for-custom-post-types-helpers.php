...
/**
 * Class Gn_Admin_Column_Generator_For_Custom_Post_Types_Helpers
 *
 * This class contains repetitive functions that
 * are used globally within the plugin.
 *
 * @package		GNADMINCOL
 * @subpackage	Classes/Gn_Admin_Column_Generator_For_Custom_Post_Types_Helpers
...
class Gn_Admin_Column_Generator_For_Custom_Post_Types_Helpers{
	 ...
	 * 
	 * GNADMINCOL()->helpers->output_text( 'my text' );
	 * 
	 */
