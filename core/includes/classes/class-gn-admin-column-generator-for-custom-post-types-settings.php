 ...
 * 
 * GNADMINCOL->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Gn_Admin_Column_Generator_For_Custom_Post_Types_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		GNADMINCOL
 * @subpackage	Classes/Gn_Admin_Column_Generator_For_Custom_Post_Types_Settings
...
class Gn_Admin_Column_Generator_For_Custom_Post_Types_Settings{
	...
	/**
	 * Our Gn_Admin_Column_Generator_For_Custom_Post_Types_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = GNADMINCOL_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'GNADMINCOL/settings/get_plugin_name', $this->plugin_name );
	}
}
